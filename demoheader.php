	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right" style="font-size:13px;">
				...
				<?php if ($role == 'admin') { ?>
					<li class="dropdown <?php if ($pagename == "packable" || $pagename == "stocklist") {
											echo "active";
										} ?>"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-list"></i> Stock<span class="caret"></span></a>
					...
					<?php if ($role == 'admin') { ?>
						<li class="dropdown <?php if ($pagename == "jobprocess" || $pagename == "jobprocess") {
												echo "active";
											} ?>"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-list"></i> Job Process<span class="caret"></span></a>
							<ul class="dropdown-menu">
				...
				<li <?php if ($pagename == "stock_movement") { ?> class="active"<?php } ?>><a href="../stock_movement?pagename=stock_movement"><i class="fa fa-file"></i>&nbsp;Stock Movement</a></li>  -->
					...
					<li <?php if (isset($_GET['pagename'])) {
								if ($pagename == "admin") { ?> class="active" <?php }
																								} ?>><a href="./admin?pagename=admin"><i class="fa fa-user"></i>&nbsp;Admin</a></li>
					<li class="dropdown <?php if ($pagename == "cuttinglist" || $pagename == "stitchinglist") {
											echo "active";
										} ?>">
