    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12" style="margin:10px">
                <a href="bale_meter_list.php?pagename=bale_meter_tally&type=list" class="btn btn-success">Bale Meter List</a>
                <a href="bale_meter_entry.php?pagename=bale_meter_tally&type=entry" class="btn btn-danger">Bale Meter Entry</a>
            </div>
