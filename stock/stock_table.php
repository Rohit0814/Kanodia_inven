<div class="container-fluid">
      <table class="table datatable" id="myTable">
            <thead>
                ...
                <th class="bg-default" style="text-align:center; vertical-align:middle;">Type</th>
                ...
                <th class="bg-primary" style="text-align:center; vertical-align:middle;">Remark</th>
            ...
            <tbody id="printable-row2">
             <?php
				...
				if(isset($_GET['query']) && trim($_GET['query'])!=""){
					$query=$_GET['query'];
					$where="shop='$shop' and (`material_type`<>null or `material_type`<>'')";
				}
				else{
					$where="`shop`='$shop' and (`material_type`<>null or `material_type`<>'')";
				}
            ...
            <tr class="printable-row">
                ...
                <td align="center"><?php $raw=$obj->get_details("`raw_material`","`name`","`id`='".$result['raw_id']."'"); echo $raw['name'];?></td>
                <td align="center"><?php echo $result['quantity'];?></td>
                <td align="center"><?php if($result['bale_id']!=''){ $bale=$obj->get_details("`packable`","`bale_no`","`id`='".$result['bale_id']."'"); echo $result['bale_id']; } else{ echo $result['remark'];} ?></td>
				<!-- <td align="center"><?php $width=$obj->get_details("`width`","`width`","`id`='".$result['width_id']."'"); if($result['width_id']!=0){echo $width['width'];} else { echo 0; }?></td> -->
				<!-- <td align="center"><?php echo $result['d_no'];?></td>
                <td align="center"><?php echo $result['meter'];?></td> -->
				<!-- <td align="center">
                ...
                <td align="center">
                	...
                	<!-- <a href="../action/deleteData.php?deleteStock=deleteStock&id=<?php //echo $id; ?>"  onclick="return confirmDel()"><i class="btn btn-danger btn-xs fa fa-trash"></i></a> -->
                </td>
            </tr>
